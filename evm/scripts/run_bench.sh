...
docker run --env PYTHONIOENCODING=UTF-8 -v $(pwd)/evmraceresults:/evmraceresults -v $(pwd)/scripts:/scripts -it evmone-evm384 /usr/bin/python3 /scripts/bench_evm384.py
