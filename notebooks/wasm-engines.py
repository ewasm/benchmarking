...
fig_plt.savefig('../images/bls12-synth-loop-vs-pairings.png', bbox_inches='tight')
...
fig_plt.savefig('../images/bls12-pairings-synth-loop-rust-wasm-evm384.png', bbox_inches='tight')
